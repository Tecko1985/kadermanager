...
- **Termine** (Training, Spiel, Sonstiges) mit individueller **Zu-/Absage** je Spieler und Teilnahme-Bilanz auf einen Blick.
...
Verwalten (Teams/Kader/Termine/Umfragen/Kasse anlegen und für jeden Spieler eintragen) dürfen nur Admins und die Gruppe **„Spielerplus Bearbeiter“** (`spielerplus-bearbeiter`). Alle übrigen eingeloggten Nutzer sehen die Mannschaften und melden sich für ihren eigenen, selbst verknüpften Kaderplatz an/ab.
